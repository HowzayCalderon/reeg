/*
  ...
  - Changed the type of `A` on the `_ClassToStudent` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
-- AlterTable
ALTER TABLE "_ClassToStudent" DROP COLUMN "A",
