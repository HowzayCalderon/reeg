...
TO TEST IF DATABASE QUERY RETURNS WANTED INFORMATION... ALSO ADD ONE TO ONE 
RELATION WITH SUBJECT AND CLASS TO CLASS MODEL.. ONCE THIS IS ALL FUNCTIONAL
 START TO ADD CLASSES TO FRONTEND DASHBOARD*/